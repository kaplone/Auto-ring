...
def dvdaut(repertoire_de_travail, nom_export, lettre_1, liste_fake) :
...
######### page des bonus ########
    ...
    lien_vignette = """                <button name="1">jump title 3; </button>
                <button name="2">jump menu entry root; </button>\n"""
    xml_inter_open.write(lien_vignette)
...
</dvdauthor>""" % (repertoire_de_travail, nom_export, repertoire_de_travail, nom_export, tc,repertoire_de_travail, nom_export, lettre_1)
