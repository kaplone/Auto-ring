...
def dvdaut(repertoire_de_travail, nom_export, liste_fake) :
...
-->
    ...
    for l in lecture_solo_last :
        if "positition de la page dans le xml" in l :
            ...
            print "+++++++++++++ derniere page avant le bonus +++++++++++++", derniere_page_avant_les_bonus, "+++++++++++++++++++++++"
    ...
    solo_debut_partie_3 = open(repertoire_de_travail + "/pages/solo_page_3_1_data.txt", "r")
    lecture_solo_debut_partie_3 = solo_debut_partie_3.readlines()
    for l in lecture_solo_debut_partie_3 :
        if "positition de la page dans le xml" in l :
            premiere_page_partie_3 = l.split("=")[-1].strip()
            
    solo_debut_partie_4 = open(repertoire_de_travail + "/pages/solo_page_4_1_data.txt", "r")
    lecture_solo_debut_partie_4 = solo_debut_partie_4.readlines()
    for l in lecture_solo_debut_partie_4 :
        if "positition de la page dans le xml" in l :
            premiere_page_partie_4 = l.split("=")[-1].strip()
        ...
        if "nombre de bonus" in l :
            ...
            if nombre_de_bonus != "0" :
                ...
                for n in range(3, int(nombre_de_liens_sur_la_page_index) +1) :
                    if n == 3 :
                        lien_page_n = """                <button name="3">jump menu 1; </button>\n"""
                    elif n == 4:
                        lien_page_n = """                <button name="4">jump menu %d; </button>\n""" % (int(premiere_page_partie_2))
                    elif n == 5:
                        lien_page_n = """                <button name="5">jump menu %d; </button>\n""" % (int(premiere_page_partie_3))
                    elif n == 6:
                        lien_page_n = """                <button name="6">jump menu %d; </button>\n""" % (int(premiere_page_partie_4))
                ...
                for n in range(2, int(nombre_de_liens_sur_la_page_index) +1) :
                    if n == 2 :
                        ...
                        lien_page_n = """                <button name="3">jump menu %d; </button>\n""" % (int(premiere_page_partie_2))
                    elif n == 4 :
                        lien_page_n = """                <button name="4">jump menu %d; </button>\n""" % (int(premiere_page_partie_3))
                    elif n == 5 :
                        lien_page_n = """                <button name="5">jump menu %d; </button>\n""" % (int(premiere_page_partie_4))
    ...
    for x in range(0, int(derniere_page_avant_les_bonus)) :
        ...
        -->\n""" % (x + 2, liste_des_datas[x])
            ...
            #### k va representer les pages par partie ####
            for k in range(1, int(dic_datas_pages["page_%d_autres_pages" % (x + 1)]) + 2) :    ##### longue galere avant de corriger en +2  la valeur superieure du range ########################
                
                print  "x=", x, "k=", k, "page en cours = ",int(dic_datas_pages["page_%d_page_en_cours" % (x + 1)]), "autres pages =", dic_datas_pages["page_%d_autres_pages" % (x + 1)] 
                
                if k != int(dic_datas_pages["page_%d_page_en_cours" % (x + 1)]) : ### pas celle en cours
                    ...
                    if int(dic_datas_pages["page_%d_page_en_cours" % (x + 1)]) != int(dic_datas_pages["page_%d_pos_xml" % (x + 1)]) -1 :
                        ...
                        if int(dic_datas_pages["page_%d_page_en_cours" % (x + 1)]) == (int(dic_datas_pages["page_%d_pos_xml" % (x + 1)]) - int(premiere_page_partie_2) + 1) :
                            cible_page = int(premiere_page_partie_2) + k - 1
                            print k, '///', 'partie 2', "cible_page =",cible_page ,'\n'
                        
                        ######### partie 3
                        
                        elif int(dic_datas_pages["page_%d_page_en_cours" % (x + 1)]) == (int(dic_datas_pages["page_%d_pos_xml" % (x + 1)]) - int(premiere_page_partie_3) + 1) :
                            cible_page = int(premiere_page_partie_3) + k - 1
                            print k, '///', 'partie 3', "cible_page =",cible_page ,'\n' 
                            
                        ######### partie 4
                        
                        else :
                            cible_page = int(premiere_page_partie_4) + k - 1
                            print k, '///', 'partie 4', "cible_page =",cible_page ,'\n' 
                    
                        
                    ######### partie 1
                    else :
                        cible_page = k + 1
                        print k, '///', 'partie 1', "cible_page =",cible_page ,'\n' 
...
</dvdauthor>""" % (repertoire_de_travail, nom_export, repertoire_de_travail, nom_export, tc)
